...
public class Game extends Canvas {
    ...
    private boolean fireRightPressed = false;
    ...
    public void tryToFireWithAngleThroughLeft() {
        // check that we have waiting long enough to fire
        if (System.currentTimeMillis() - lastFire < firingInterval) {
            return;
        }
        ...
        // if we waited long enough, create the shot entity, and record the time.
        lastFire = System.currentTimeMillis();
        ShotEntity shot = new ShotEntity(this, "sprites/shot.gif", ship.getX() + 50, ship.getY() - 30);
        entities.add(shot);
    }

    public void tryToFireWithAngleThroughRight() {
        // check that we have waiting long enough to fire
        if (System.currentTimeMillis() - lastFire < firingInterval) {
            return;
        }
        ...
        // if we waited long enough, create the shot entity, and record the time.
        lastFire = System.currentTimeMillis();
        ShotEntity shot = new ShotEntity(this, "sprites/shot.gif", ship.getX() - 20, ship.getY() - 30);
        entities.add(shot);
    }
    ...
    public void gameLoop() {
        ...
        while (gameRunning) {
            ...
            if (fireRightPressed) {
                tryToFireWithAngleThroughRight();
            }

            if (fireLeftPressed) {
                tryToFireWithAngleThroughLeft();
            }
